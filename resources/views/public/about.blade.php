...
@section('content')
    ...
    <div class="about_bg">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1>Tentang STIE Pelita Buana</h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-7">
                ...
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.
                    ...
                    <a href="javascript:;" class="btn btn-default btn-about">VIEW OUR COURSE</a>
                </div>
                <div class="col-md-5">
                    <img src="public/images/welcome-img.jpg" class="img-fluid" alt="#">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="single-item">
                        <div class="quote">
                            ...
                            <div class="testi-img_block">
                                <img src="public/images/testi-img.jpg" class="img-fluid" alt="#">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3 chart_bottom">
                    <div class="chart-img">
                        <img src="public/images/chart-icon_1.png" class="img-fluid" alt="chart_icon">
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 chart_bottom chart_top">
                    <div class="chart-img">
                        <img src="public/images/chart-icon_2.png" class="img-fluid" alt="chart_icon">
                    </div>
                    <div class="chart-text">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 chart_top">
                    <div class="chart-img">
                        <img src="public/images/chart-icon_3.png" class="img-fluid" alt="chart_icon">
                    </div>
                    <div class="chart-text">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="chart-img">
                        <img src="public/images/chart-icon_4.png" class="img-fluid" alt="chart_icon">
                    </div>
                    <div class="chart-text">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="our-teachers-block">
                        <img src="public/images/our-teachers_01.jpg" class="img-fluid teachers-img" alt="#">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="our-teachers-block">
                        <img src="public/images/our-teachers_02.jpg" class="img-fluid teachers-img" alt="#">
                        <div class="teachers-description">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="our-teachers-block">
                        <img src="public/images/our-teachers_03.jpg" class="img-fluid teachers-img" alt="#">
                        <div class="teachers-description">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="our-teachers-block">
                        <img src="public/images/our-teachers_04.jpg" class="img-fluid teachers-img" alt="#">
                        <div class="teachers-description">
