<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-body">
      {{ Form::open(array('class' => 'form-horizontal', 'id' => 'form-tambah-'.$uri)) }}
        ...
        <div class="form-group row m-b-15">
          ...
          <div class="col-md-9">
            {{ Form::select('jabatan', $jabatan, [], ['class' => 'form-control selectpicker dropup', 'size' => '5', 'data-live-search' => 'true', 'data-style' => 'btn-white', 'data-toggle'=>'ajax', 'id' => 'jabatan']) }}
          </div>
        </div>
        {{ Form::close() }}
    </div>
    <div class="modal-footer bg-grey-transparent-2">
      <a href="javascript:;" class="btn btn-primary" onclick="save_data('{{ $uri }}')">Simpan</a>
    </div>
  </div>
</div>
<script>
