  ...
  $.when(
    ...
    table = $(".table").length&&$(".table").DataTable({
      ...
      columns: [
        ...
        { data: 'nama', sClass:'text-nowrap'},
        { data: 'gender', sClass:'text-nowrap text-center'},
        { data: 'alamat'},
        { data: 'tlp', sClass:'text-nowrap'},
        { data: 'jabatan', sClass:'text-nowrap'},
      ]
    });
