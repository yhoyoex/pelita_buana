  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group row m-b-15">
          ...
          <div class="col-md-9">
            {{ Form::select('menu', $menu,[], ['class' => 'form-control selectpicker dropup', 'size' => '5', 'data-live-search' => 'true', 'data-style' => 'btn-white', 'data-header'=> 'Select Menu', 'data-toggle'=>'ajax']) }}
          </div>
      </div>
      {{ Form::close() }}
